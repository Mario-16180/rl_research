...
def train_vanilla_dqn(name_env, episodes, batch_size, gamma, epsilon_start, epsilon_decay, epsilon_min,  
                      ...
                      initial_random_experiences=5000, memory_capacity=1000000, resume=False, project_name="rl_research_mbzuai"):
    ...
    for episode in tqdm(range(current_episode, episodes)):
        ...
        while not done:
            ...
            if current_step % 250 == 0:
                ...
                model_policy.save_model(episode=episode, optimizer=optimizer, loss=loss, path='models/trained_models/checkpoint.tar')
