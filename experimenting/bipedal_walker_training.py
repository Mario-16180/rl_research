...
if __name__ == "__main__":
    ...
    parser.add_argument('--sweep', type=lambda x: bool(strtobool(x)), default=False, help='Whether to sweep or not')
    ...
    train_sac_bipedal_walker(name_env, gpu, alpha, beta, theta, use_curriculum, n_episodes, max_t, batch_size, gamma, tau, temperature_factor,
