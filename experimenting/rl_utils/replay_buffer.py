...
class memory_with_curriculum():
    ...
    def populate_memory_model(self, model, environment, k_initial_experiences):
...
if __name__ == '__main__':
    ...
    memory_object = memory_with_curriculum(max_size=100000)
    memory_object.populate_memory_model(env, k_initial_experiences=5000)
